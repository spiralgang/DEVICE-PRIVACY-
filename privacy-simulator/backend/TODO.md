# Privacy Simulator — Emulator Build TODO

Status: implemented + verified (ad-hoc, live server). Pushed to branch
`privacy-simulator-emulator` of spiralgang/DEVICE-PRIVACY.

## Done
- [x] Convert privacy-simulator into a REAL emulator (no sim) using Puter.js
